...
1. **Hesap Oluşturun:** [commit.dixtuel.tr](https://commit.dixtuel.tr) adresine gidin, hesabınızı oluşturup yeni bir proje ekleyin. Proje ayarlarında birden fazla branch seçebilirsiniz; boş seçim tüm branch'leri izler. Seçim webhook olaylarına, elle GitHub senkronizasyonuna, changelog sayfasına, export'lara ve widget'lara uygulanır.
